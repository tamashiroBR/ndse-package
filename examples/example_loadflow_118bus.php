<?php
/**
 * Example: Load Flow — IEEE 118-Bus System
 *
 * This example demonstrates how to run a Newton-Raphson Load Flow
 * using the IEEE 118-bus test system data loaded from a JSON file.
 * The data corresponds to Appendix A.3 of:
 *
 ...
 *
 * Usage:
 *   php example_loadflow_118bus.php
 */
...
$jsonFile = __DIR__ . '/loadflow_118bus.json';
...
echo "Running Load Flow — IEEE 118-Bus System...\n\n";
...
echo "=============================================================\n";
echo "  Load Flow Results — IEEE 118-Bus System\n";
echo "=============================================================\n";
